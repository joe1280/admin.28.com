...
.explode {
  background:url(/tp/admin.28.com/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/tp/admin.28.com/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/tp/admin.28.com/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/tp/admin.28.com/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
                <?php foreach($auth as $k=>$v): if($v['auth_level']>0) continue; ?>    
		  <li class="explode" key="02_cat_and_goods" name="menu">
             <?php echo $v['auth_name']; ?>
           
                <ul>
                   
                                    <?php foreach($auth as $kk=>$vv): if($vv['auth_pid']!==$v['auth_id']) continue; ?>
                 

                                    <li class="menu-item"><a href="/tp/admin.28.com/index.php/<?php echo $vv['auth_m']?>/<?php echo $vv['auth_c']; ?>/<?php echo $vv['auth_a']; ?>" target="main-frame"><?php echo $vv['auth_name']; ?></a></li>
		 ...
		 <li class="explode" key="04_order" name="menu">
            系统模块
                <ul>
                    <li class="menu-item"><a href="/tp/admin.28.com/index.php/Gii/Index/index" target="main-frame">代码生成器</a></li>
...
<script type="text/javascript" src="/tp/admin.28.com/Public/Js/global.js"></script>
<script type="text/javascript" src="/tp/admin.28.com/Public/Js/utils.js"></script>
<script type="text/javascript" src="/tp/admin.28.com/Public/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/tp/admin.28.com/Public/Images/menu_minus.gif' : '/tp/admin.28.com/Public/Images/menu_plus.gif';
